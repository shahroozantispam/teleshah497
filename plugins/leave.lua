...
local function run(msg)
  if msg.service and msg.action.type == 'chat_add_user' then
    ...
    if not data[tostring(msg.to.id)] then
      print "wait until i ask my Dad that why you added me!\n\nOh No\n\nMy Dady Saied : I fucked your mother , Wtf"
      chat_del_user('channel#id'..msg.to.id, 'user#id'..our_id, callback, false)
    end
  end
end
